 ...
 * 
 */
public class AdapterListEntrainPanelImpl
//@non-generated-start[class-signature-extends][X]
		extends MDKAdapter<Entrainement, VMListEntrainPanel, VMListListEntrainPanel>
//@non-generated-end
...
//@non-generated-end
{
	...
	/**
	 * Constructor for AdapterListEntrainPanelImpl
	 * @param p_oMasterVM the parent view model

	 */
	public AdapterListEntrainPanelImpl(VMListListEntrainPanel p_oMasterVM) {

		super(p_oMasterVM, R.layout.glistentrainpanel__listitem1__master, R.id.glistentrainpanel__listitem1__master);
	 ...
	 */
	@Override
	public void postInflate(MDKAdapter<Entrainement, VMListEntrainPanel, VMListListEntrainPanel> p_oAdapter, View p_oCurrentRow, boolean b_isExpanded) {
	 ...
	 */
	@Override
	public void postBind(MDKAdapter<Entrainement, VMListEntrainPanel, VMListListEntrainPanel> p_oAdapter, View p_oCurrentRow,
			VMListEntrainPanel p_oCurrentVM, boolean b_isExpanded, int... p_oPositions) {
